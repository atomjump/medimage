...
var app = {
   ...
   get: function(url, cb) {
	...
	traceWound: function(imageURI) {
		...
		glbThis.cancelNotify("<ons-icon style=\"vertical-align: middle; color:#f7afbb;\" size=\"30px\" icon=\"fa-close\" href=\"#javascript\" onclick=\"window.open(\"http:\/\/104.131.151.99:5567\/addon\/show-analysis?photo=" + imageURI + "\&style=mob\", \"_system\");\"></ons-icon><br/>Measure Wound");  
		//   
	},
